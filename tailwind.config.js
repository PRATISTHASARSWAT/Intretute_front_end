    ...
    extend: {
      colors: {
        ...
        brand: {
          ...
          secondary: 'var(--color-brand-secondary)', // violet-600
          trust: 'var(--color-brand-trust)', // slate-900
      ...
      boxShadow: {
        ...
        'brand-xl': '0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05)',
      },
